...
function inverterParametro(valor){
...
console.log(inverterParametro(true))
console.log(inverterParametro(false))
console.log(inverterParametro(1))
console.log(inverterParametro('0'))